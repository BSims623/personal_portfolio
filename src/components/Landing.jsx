...
const Landing = ({ landingRef }) => {
    ...
    return (
        <section ref={landingRef} id='Landing' className='' style={{ display: 'flex', justifyContent: 'center', alignItems: 'end', width: '100vw', height: '94vh', backgroundImage: `url(${landingImage})`, backgroundSize: 'cover', backgroundPosition: 'center', padding: '0 15px' }}>
            <div className="mb-5">
